...
public:
	...
	// bone at the specified time in the animation.
	// It is expected that the time is >= 0.0f and <= mDuration
	void getGlobalPoseAtTime(vector<Matrix4>& outPoses, const class
	Skeleton* inSkeleton, float inTime) const;
